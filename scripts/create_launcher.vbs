...
electron_dir = fso.GetParentFolderName(fso.GetParentFolderName(app_dir))
...
desktop_link.TargetPath = electron_dir & "\\electron.exe"
...
app_link.TargetPath = electron_dir & "\\electron.exe"
